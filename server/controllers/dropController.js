...
const Drop = require("../models/Drop") // Assumes Drop model is here
...
  if (plan === "FREE") return expiry.freeMaxHours // 24 hours
...
  if (plan === "FREE") return dlLimits.free
  return dlLimits.anon
}
...
    const defaultMaxDownloads = getMaxDropDownloads(plan)
